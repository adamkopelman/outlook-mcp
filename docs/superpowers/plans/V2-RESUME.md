...
- [ ] Plan 12 — Notes CRUD (list filters, get fields, create additions, update_note, delete_note) — **NEXT ACTION: write the Plan 12 doc, then execute task-by-task via subagent-driven-development.**
