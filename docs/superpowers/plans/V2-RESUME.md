...
- [ ] Plan 11 — Tasks CRUD (list filters, create additions, update_task[absorbs complete_task], delete_task) — **NEXT ACTION: write the Plan 11 doc, then execute task-by-task via subagent-driven-development.**
